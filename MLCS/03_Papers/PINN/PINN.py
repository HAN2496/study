...
class Burgers(Model):
    ...
    def __init__(self):
        ...
        self.h1 = Dense(node_num, activation='tanh')
        self.h2 = Dense(node_num, activation='tanh')
        self.h3 = Dense(node_num, activation='tanh')
        self.h4 = Dense(node_num, activation='tanh')
        self.h5 = Dense(node_num, activation='tanh')
        self.h6 = Dense(node_num, activation='tanh')
